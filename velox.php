...
require_once VELOX_PATH . 'includes/class-velox-seo-columns.php';
...
require_once VELOX_PATH . 'includes/class-velox-builder.php';
require_once VELOX_PATH . 'includes/class-velox-icons.php';
require_once VELOX_PATH . 'includes/class-velox-builder-render.php';
require_once VELOX_PATH . 'includes/class-velox-redirects.php';
require_once VELOX_PATH . 'includes/class-velox-reviews.php';
require_once VELOX_PATH . 'includes/class-velox-reviews-oxygen.php';
