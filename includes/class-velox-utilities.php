...
class Velox_Utilities {
	...
	public static function catalog() {
		return array(
			...
			'builder'    => array( 'label' => 'Velox Builder',       'icon' => 'grid',     'ready' => true,  'enable' => 'module_builder', 'setting' => 'module_builder', 'desc' => 'A clean, class-first visual page builder that renders its own standalone document and ships only the CSS each page uses. Gets its own Velox Builder menu section.' ),
			...
			'reviews'    => array( 'label' => 'Google Reviews',      'icon' => 'globe',    'ready' => true,  'enable' => 'util_reviews', 'page' => true, 'desc' => 'Show your Google reviews as a styleable slider or grid. Connect via Featurable or the Google Places API, save reusable design presets, and drop them anywhere with a shortcode or the Oxygen tab.' ),
			...
			'frontendbar'=> array( 'label' => 'Frontend admin tools', 'icon' => 'bolt',     'ready' => true,  'enable' => 'util_frontendbar', 'setting' => 'util_frontendbar', 'desc' => 'A small arrow at the bottom-left of the front end (admins only) that opens quick actions: toggle the admin bar, purge cache, maintenance mode, edit this page, Oxygen &amp; WordPress settings, and view the page as a visitor.' ),
