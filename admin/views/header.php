...
<div class="velox-app">
	...
	<aside class="velox-sidebar">
		<div class="velox-side-brand">
			...
			<button type="button" class="velox-side-collapse" id="velox-side-collapse" aria-label="Collapse menu" title="<?php esc_attr_e('Collapse menu', 'velox'); ?>">
		...
		<div class="velox-side-foot">
			...
			<a class="velox-side-foot-gear<?php echo ( 'settings' === $current ) ? ' is-active' : ''; ?>" href="<?php echo esc_url( $admin->tab_url( 'settings' ) ); ?>" aria-label="Settings" title="<?php esc_attr_e('Settings', 'velox'); ?>">
				...
				<div class="velox-wizard-step" data-step="path" hidden>
					...
					<div class="velox-wiz-paths">
						<button type="button" class="velox-wiz-path is-selected" data-path="auto">
							...
							<span class="velox-wiz-path-t"><?php esc_html_e('Detect &amp; recommend', 'velox'); ?></span>
